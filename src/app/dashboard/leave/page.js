    ...
    <div className="p-4 lg:p-6">
      <div className="mb-6">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Manajemen Cuti</h1>
            <p className="text-gray-600 mt-1">Kelola pengajuan cuti pegawai</p>
          </div>
          <Link
                  ...
                  <tr key={leave.id} className="hover:bg-gray-50">
                    <td className="px-3 lg:px-6 py-4">
                      <div className="flex flex-col">
                        ...
                        <div className="sm:hidden text-xs text-gray-500 mt-1 max-w-xs truncate">
                          {leave.reason}
                        </div>
